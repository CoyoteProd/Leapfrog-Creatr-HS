...
#define STRING_CONFIG_H_AUTHOR "(Martijn Vos)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Leapfrog Mod Bij M.vos"
...
#define HOTEND_OFFSET_X {0.0, -15.00} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 */
//#define PIDTEMPBED //DISABLE FOR TESTING !!!
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {(100.0/3)*2, (100.0/3)*2, 9600.0/10, 99.30} 
